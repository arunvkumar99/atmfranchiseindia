  ...
  const testimonials = [
    {
      ...
      business: "EPS ATM Franchise",
      rating: 5,
      revenue: "₹45,000/month",
      testimonial: "ATM Franchise India guided me through every step. Within 8 months, I'm earning ₹45,000 monthly with minimal effort. Best investment decision ever!",
      months: 8
    },
    {
      name: "Priya Sharma",
      location: "Bangalore, Karnataka", 
      business: "Vakrangee Partnership",
      rating: 5,
      revenue: "₹38,000/month",
      testimonial: "The team's expertise in WLA partnerships is unmatched. My ATM is generating consistent ₹38,000 monthly income in just 6 months.",
      months: 6
    },
    {
      name: "Amit Patel",
      location: "Ahmedabad, Gujarat",
      business: "Indicash Franchise",
      rating: 5,
      revenue: "₹52,000/month",
      testimonial: "Professional guidance and complete transparency. ROI achieved in 14 months with ₹52,000 monthly passive income. Highly recommended!",
      months: 14
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Don't just take our word for it. Here are genuine success stories from our franchise partners across India.
          </p>
        </div>
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-gray-500">in {testimonial.months} months</div>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="text-center mt-12">
          <div className="bg-blue-50 rounded-2xl p-6 max-w-2xl mx-auto">
            <h3 className="font-bold text-xl text-gray-900 mb-2">Average Partner Performance</h3>
