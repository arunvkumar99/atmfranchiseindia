      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">
            Join the <span className="text-primary font-bold">Sahasra Network Influencer Program</span>
          </h1>
        ...
        <div className="mb-8">
          <div className="relative overflow-hidden rounded-2xl shadow-2xl">
            <img
              src={businessGrowth}
              alt="Influencer Partnership Growth"
              className="w-full h-[200px] sm:h-[300px] object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
              <div className="text-white p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold mb-2">Promote a Trusted Business Model</h3>
                <p className="text-sm opacity-90">Help your audience discover financial independence while earning attractive referral commissions</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-muted/50 border border-border rounded-2xl shadow-xl overflow-hidden">
            <div className="relative p-6 sm:p-8">
              <div className="text-center mb-6">
                <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4">Benefits for Influencers Who Join the Sahasra Network</h2>
              </div>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base">Attractive Commissions</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Earn competitive commissions for every successful franchise partnership</p>
                </div>
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                    <Target className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base">Flexible Promotion</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Promote our franchise model on your channels with flexible content formats</p>
                </div>
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                    <MapPin className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base">Authentic Brand</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Partner with a trusted brand that has 4+ years of proven track record</p>
                </div>
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">Access professional marketing materials, tracking links, and ongoing assistance</p>
                </div>
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">Clear commission structure and timely payouts with full transparency</p>
                </div>
                <div className="bg-white border border-border rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                    <ArrowUp className="w-6 h-6 text-primary" />
                  </div>
                  <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base">Growth Opportunity</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Scale your income as our network grows and expands across India</p>
                </div>
              </div>
            </div>
          </div>
